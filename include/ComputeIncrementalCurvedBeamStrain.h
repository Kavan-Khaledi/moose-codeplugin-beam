...
public:
  ...
  ComputeIncrementalCurvedBeamStrain(const InputParameters & parameters);
...
protected:
  ...
  RealVectorValue _disp0, _disp1, _disp2, _rot0, _rot1, _rot2;
  ...
  std::vector<unsigned int> _soln_disp_index_2;
  ...
  std::vector<unsigned int> _soln_rot_index_2;
