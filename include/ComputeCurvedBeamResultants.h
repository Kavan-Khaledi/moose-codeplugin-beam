...
/**
 * ComputeCurvedBeamResultants computes forces and moments using elasticity
 */
class ComputeCurvedBeamResultants : public Material
{
public:
  static InputParameters validParams();

  ComputeCurvedBeamResultants(const InputParameters & parameters);
...
protected:
  ...
  MaterialProperty<RealVectorValue> & _beam_force;
  MaterialProperty<RealVectorValue> & _beam_moment;
